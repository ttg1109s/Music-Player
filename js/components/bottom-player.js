...
const TPL_BOTTOM_PLAYER = `
    <div id="player-container" class="absolute bottom-0 left-0 w-full z-[70] pointer-events-auto flex flex-col hidden">
        <div class="w-full bg-black px-3 sm:px-6 pt-2"><input type="range" id="progress-bar" value="0" step="0.1" min="0" class="music-slider block"></div>

        <div class="w-full bg-black bg-gradient-to-t from-black via-black/90 to-transparent pt-3 pb-3 px-3 sm:px-6 flex items-center justify-between gap-2 sm:gap-6">
