...
modal liên quan thông tin/ảnh bài hát chuyển sang đúng theme kính mờ
(`glass-panel`) của toàn app, thêm logo "SAV" hover trượt chữ ở góc Playlist,
ô tìm kiếm lọc thêm theo album, và `js/components/settings-drawer.js` (từng
dồn ~28KB HTML vào 1 file) được tách thành 5 file con theo từng khối cài
đặt. Chi tiết đầy đủ ở [changelog/v8.md](./changelog/v8.md). Ver 7 trước đó
...
└── js/
    ...
    │   ├── playlist-view.js     (★★★★★ ver 5, ★★★★★★ ver 6 — ô tìm kiếm, z-index, bỏ sort random; ★★★★★★★★ ver 8 — logo SAV, tab "Ảnh bìa" trong modal sửa thông tin, glass-panel cho modal sửa/info)
    ...
    │   ├── dom-refs.js          (★ ver 1, ★★★ ver 3, ★★★★ ver 4, ★★★★★ ver 5, ★★★★★★ ver 6 — ref keepScreenOnToggle; ★★★★★★★★ ver 8 — ref savLogo)
...
| Logo "SAV" góc trái Playlist (hiệu ứng hover trượt chữ) | `js/components/playlist-view.js` (khối `#sav-logo`, thuần CSS `max-width` transition) |
...
| Toàn bộ màu sắc/giao diện CSS, theme kính mờ (`.glass-panel`/`.drawer-glass`) | `css/styles.css` |
